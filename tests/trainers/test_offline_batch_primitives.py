...
def test_online_dispatch_and_offline_binding_share_the_non_model_firewall() -> None:
    batch = {key: object() for key in NON_MODEL_CONDITION_KEYS}
    batch["prompt_embeds"] = torch.ones(1, 2)
